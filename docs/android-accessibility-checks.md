...
1. Enable TalkBack. Navigate Home → languages → translation → About. Confirm each download/delete names its model or language, swap announces its purpose, and status/decorations are not read twice.
