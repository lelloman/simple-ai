...
object LocalAIModel {
    ...
    const val DESCRIPTION = "On-device text generation and chat"
    const val REVISION = "dcb19155b962dbb6389f4691a982043a8e651022"
    const val URL = "https://huggingface.co/bartowski/Qwen_Qwen3-1.7B-GGUF/resolve/$REVISION/Qwen_Qwen3-1.7B-Q4_K_M.gguf"
    const val FILE_NAME = "Qwen_Qwen3-1.7B-Q4_K_M.gguf"
    const val SIZE_BYTES = 1282439584L
    const val SIZE_MB = (SIZE_BYTES / 1_000_000).toInt()
    const val SHA256 = "72c5c3cb38fa32d5256e2fe30d03e7a64c6c79e668ad84057e3bd66e250b24fb"
    const val SUPPORTS_TOOLS = false
}
